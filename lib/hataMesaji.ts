...
const SOZLUK: Record<string, string> = {
  ...
  NOT_OWNER: "Bunu yalnızca grubu kuran kişi yapabilir.",
  NOT_MEMBER: "Bu kişi grupta değil.",
  OWNER_CANNOT_BE_REMOVED: "Grubu kuran kişi gruptan çıkarılamaz.",
  OWNER_CANNOT_LEAVE: "Grubu kuran kişi gruptan ayrılamaz.",
